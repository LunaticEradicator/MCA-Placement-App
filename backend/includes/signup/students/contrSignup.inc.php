...
function isInputEmpty($studentUsername, $studentRollno, $studentEmail, $studentPassword, $studentPhone)
{
    if (
        ...
        || empty($studentRollno) || empty($studentPhone)
    ) {
        return true;
    } else {
        return false;
...
function createUser($pdo, $studentUsername, $studentRollno, $studentEmail, $studentPassword, $studentPhone, $studentCgpa, $studentBacklog)
{
    setUsers($pdo, $studentUsername, $studentRollno, $studentEmail, $studentPassword, $studentPhone, $studentCgpa, $studentBacklog);
};
