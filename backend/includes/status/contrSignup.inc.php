...
function isInputEmpty($studentUsername, $studentRollno, $studentEmail, $studentPassword, $studentPhone, $studentCgpa, $studentBacklogs)
{
    if (
        empty($studentUsername) || empty($studentEmail) || empty($studentPassword)
...
function createUser($pdo, $studentUsername, $studentRollno, $studentEmail, $studentPassword, $studentPhone, $studentCgpa, $studentBacklogs)
{
    setUsers($pdo, $studentUsername, $studentRollno, $studentEmail, $studentPassword, $studentPhone, $studentCgpa, $studentBacklogs);
};
